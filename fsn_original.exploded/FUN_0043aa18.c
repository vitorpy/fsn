...

{
  ...
  (**(code **)(unaff_gp + -0x7ef4))(auStack_80,0x80);
  auStack_80[*param_1 >> 5] = auStack_80[*param_1 >> 5] | 1 << (*param_1 & 0x1f);
  piVar2 = (int *)param_1[1];
  if (((*(int *)(*piVar2 + 0xc) != 0) ||
      (((iVar1 = (**(code **)(unaff_gp + -0x76fc))(), iVar1 != -1 &&
        (*(int *)(*piVar2 + 0x179c) == 0)) && (*(int *)(*piVar2 + 0xc) != 0)))) &&
     (iVar1 = (**(code **)(unaff_gp + -0x76f8))(piVar2,*param_1,auStack_c38,0x400), iVar1 != -1)) {
    (*(code *)(*(int *)(unaff_gp + -0x7fdc) + -0x599c))(param_1,auStack_c38,param_2);
  }
