...

{
  ...
  if (-1 < *(int *)(param_1 + 0x74) << 0xd) {
    ...
    iVar1 = (**(code **)(unaff_gp + -0x7c20))(local_c);
    iVar1 = iVar1 + local_c;
    (**(code **)(unaff_gp + -0x7ecc))(iVar1,param_2);
    iVar2 = (**(code **)(unaff_gp + -0x7ee0))(local_c,auStack_94);
    if (-1 < iVar2) {
      ...
      *(byte *)(param_1 + 0x75) = bVar5 & 0x3f;
      if ((local_80 & 0xf000) == 0x4000) {
        iVar2 = (**(code **)(unaff_gp + -0x7a58))(param_1,param_2);
        if (iVar2 == 0) {
          puVar3 = (undefined4 *)(*(code *)(*(int *)(unaff_gp + -0x7fe8) + 0x1c04))();
          if (*(int *)(param_1 + 0x14) == 0) {
            uVar4 = (**(code **)(unaff_gp + -0x7c48))(4);
            *(undefined4 *)(param_1 + 0x18) = uVar4;
          }
          else {
            uVar4 = (**(code **)(unaff_gp + -0x7e74))
          ...
          *puVar3 = uVar4;
          uVar4 = (**(code **)(unaff_gp + -0x7c20))(param_2);
          puVar3[1] = uVar4;
        ...
        if (iVar1 == 0) {
          puVar3 = (undefined4 *)(*(code *)(*(int *)(unaff_gp + -0x7fe8) + 0x1b84))();
