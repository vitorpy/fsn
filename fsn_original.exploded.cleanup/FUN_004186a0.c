...

{
  ...
  *(byte *)(param_1 + 0x75) = *(byte *)(param_1 + 0x75) & 0xef;
  (**(code **)(unaff_gp + -0x78e8) /* -> FUN_00427ec8 */)();
  ...
  iVar3 = 0;
  if (iVar1 != 0) {
    (**(code **)(unaff_gp + -0x7f40) /* -> EXTERNAL_0x0fabf650 */)(*(undefined4 *)(param_1 + 0x10));
  ...
  if (0 < iVar1) {
    do {
      (**(code **)(unaff_gp + -0x7a18) /* -> FUN_004186a0 */)(*(undefined4 *)(*(int *)(param_1 + 0x18) + iVar2));
  ...
  if (iVar1 != 0) {
    (**(code **)(unaff_gp + -0x7f40) /* -> EXTERNAL_0x0fabf650 */)(*(undefined4 *)(param_1 + 0x18));
