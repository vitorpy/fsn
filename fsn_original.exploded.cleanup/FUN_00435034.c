...

{
  ...
  if ((param_1 == (undefined1 *)0x0) &&
     (param_1 = (undefined1 *)(**(code **)(unaff_gp + -0x7b5c) /* -> EXTERNAL_0x0f8b5990 */)(100), param_1 == (undefined1 *)0x0))
  {
    halt_baddata();
  }
  uVar1 = *(undefined4 *)(unaff_gp + -0x7610) /* -> __vtbl__13ByteCodedIcon */;
  ...
  *(undefined4 *)(param_1 + 0x60) = uVar1;
  if (*(int *)(param_2 + 0x20) == 0) {
    *(undefined4 *)(param_1 + 0x18) = 0;
    ...
    uVar1 = (**(code **)(unaff_gp + -0x7b5c) /* -> EXTERNAL_0x0f8b5990 */)(*(int *)(param_2 + 0x20));
    *(undefined4 *)(param_1 + 0x18) = uVar1;
    (**(code **)(unaff_gp + -0x7e64) /* -> EXTERNAL_0x0fac09fc */)
