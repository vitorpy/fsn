...

{
  ...
  uVar11 = 0;
  psVar10 = (short *)(*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6f70);
  iVar12 = *(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6f72;
  iVar13 = *(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6f74;
  piVar14 = (int *)(*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6fd0);
  do {
    (**(code **)(unaff_gp + -0x7af0) /* -> EXTERNAL_0x0f120d38 */)(uVar11 & 0xffff,psVar10,iVar12,iVar13);
    uVar11 = uVar11 + 1;
  ...
  iVar13 = *(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */;
  iVar12 = *(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */;
  psVar10 = (short *)(*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6f70);
  piVar14 = (int *)(*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x7010);
  do {
    iVar3 = (int)*psVar10;
    iVar4 = (int)psVar10[1];
    iVar5 = (int)psVar10[2];
    psVar1 = (short *)(*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6f70);
    piVar2 = piVar14;
    do {
      iVar7 = iVar3 + *psVar1;
      if (iVar7 < 0) {
