...

{
  ...
  if (**(char **)(unaff_gp + -0x76c4) /* -> overviewActive */ != '\0') {
    ...
    if (iVar2 != 0) {
      ...
      (**(code **)(unaff_gp + -0x7e08) /* -> EXTERNAL_0x0f123f38 */)(&local_c);
      (**(code **)(unaff_gp + -0x7e08) /* -> EXTERNAL_0x0f123f38 */)(&local_14);
      (**(code **)(unaff_gp + -0x7b94) /* -> EXTERNAL_0x0f124574 */)();
    }
    (**(code **)(unaff_gp + -0x7b48) /* -> EXTERNAL_0x0f127d3c */)();
    (**(code **)(unaff_gp + -0x7b78) /* -> EXTERNAL_0x0f123238 */)();
    (**(code **)(unaff_gp + -0x7e10) /* -> EXTERNAL_0x0f128180 */)
    ...
    (**(code **)(unaff_gp + -0x7da8) /* -> EXTERNAL_0x0f125b1c */)(uVar1);
