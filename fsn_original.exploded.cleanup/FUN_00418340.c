...

{
  ...
  if (-1 < *(int *)(param_1 + 0x74) << 0xd) {
    ...
    (**(code **)(unaff_gp + -0x7ce4) /* -> EXTERNAL_0x0fac11fc */)(local_c,param_2);
    iVar1 = (**(code **)(unaff_gp + -0x7ee0) /* -> EXTERNAL_0x0facbb68 */)(local_c,auStack_94);
    if (iVar1 < 0) {
      ...
      *(byte *)(param_1 + 0x75) = bVar2 & 0x3f;
      ...
      if (iVar1 == 0) {
        iVar1 = (**(code **)(unaff_gp + -0x7a58) /* -> FUN_00413610 */)(param_1,param_2);
        if (iVar1 != 0) {
