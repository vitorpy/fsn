...

{
  ...
  if (*(int *)(param_1 + 0x74) << 3 < 0) {
    (**(code **)(unaff_gp + -0x7e1c) /* -> EXTERNAL_0x0f1283cc */)((int)*(short *)(param_1 + 0x5e));
    if (*(int *)(param_1 + 0x74) << 2 < 0) {
      uVar3 = *(undefined4 *)(**(int **)(unaff_gp + -0x768c) /* -> boxDir */ + 0x10);
    }
    else {
      uVar3 = *(undefined4 *)**(undefined4 **)(unaff_gp + -0x768c) /* -> boxDir */;
    }
    (**(code **)(unaff_gp + -0x7b9c) /* -> EXTERNAL_0x0f124424 */)(uVar3);
    if (*(int *)(param_1 + 0x74) << 0xd < 0) {
      dVar7 = (double)*(float *)(param_1 + 0x3c) / (double)((ulonglong)unaff_000010a0 << 0x20);
      (**(code **)(unaff_gp + -0x7df0) /* -> EXTERNAL_0x0f1253e4 */)
      ...
      dVar7 = (double)*(float *)(param_1 + 0x3c) / (double)((ulonglong)unaff_000010a0 << 0x20);
      (**(code **)(unaff_gp + -0x7e20) /* -> EXTERNAL_0x0f1273b8 */)
                ((float)((double)*(float *)(param_1 + 0x34) -
                        dVar7 * (double)*(float *)(param_1 + 0x58)),
                 (float)((double)*(float *)(param_1 + 0x38) - dVar7));
      iVar2 = *(int *)(param_1 + 0x14);
    ...
    if (0 < iVar2) {
      ...
      do {
        ...
        if (iVar1 << 3 < 0) {
          if (param_2 != '\0') {
            (**(code **)(unaff_gp + -0x7990) /* -> FUN_00420408 */)(iVar4,1);
            (**(code **)(unaff_gp + -0x7e1c) /* -> EXTERNAL_0x0f1283cc */)((int)*(short *)(iVar4 + 0x5e));
            iVar1 = *(int *)(iVar4 + 0x74);
          }
          if (iVar1 << 2 < 0) {
          ...
          (**(code **)(unaff_gp + -0x7e08) /* -> EXTERNAL_0x0f123f38 */)(&local_10);
          (**(code **)(unaff_gp + -0x7e08) /* -> EXTERNAL_0x0f123f38 */)(&local_18);
          (**(code **)(unaff_gp + -0x7b94) /* -> EXTERNAL_0x0f124574 */)();
          if (param_2 == '\0') {
            (**(code **)(unaff_gp + -0x7990) /* -> FUN_00420408 */)(iVar4,0);
          }
          iVar2 = *(int *)(param_1 + 0x14);
        }
        iVar5 = iVar5 + 4;
