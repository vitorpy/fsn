...

{
  ...
  if (iVar2 == 0) {
    ...
    *(int *)(iVar2 + 0x40) = *(int *)(iVar2 + 0x40) + 1;
    ...
    puVar1 = (undefined4 *)(*(int *)(**(int **)(unaff_gp + -0x767c) /* -> curcontextwindows */ + 0x34) + iVar3 * 0x38);
    puVar7 = local_38;
    do {
      puVar6 = puVar7;
      puVar5 = puVar1;
