...

{
  ...
  iVar1 = (**(code **)(unaff_gp + -0x7a5c) /* -> FUN_00413580 */)();
  if (iVar1 != 0) {
    local_8 = (**(code **)(unaff_gp + -0x7a84) /* -> FUN_00411b30 */)(0,param_1);
    (**(code **)(unaff_gp + -0x7ce4) /* -> EXTERNAL_0x0fac11fc */)(local_8,param_2);
    iVar2 = (**(code **)(unaff_gp + -0x7ee0) /* -> EXTERNAL_0x0facbb68 */)(local_8,auStack_90);
    if (-1 < iVar2) {
      if (((local_7c != *(int *)(iVar1 + 8)) || (local_60 != *(int *)(iVar1 + 0xc))) ||
        ...
        *(int *)(iVar1 + 0x10) = local_50;
        uVar4 = (**(code **)(unaff_gp + -0x77e8) /* -> FUN_00433b44 */)(local_8);
        *(undefined4 *)(iVar1 + 0x20) = uVar4;
        piVar3 = (int *)(*(int *)(unaff_gp + -0x7f98) /* -> small */ + 0x184);
        if (*piVar3 < *(int *)(iVar1 + 0xc)) {
          *piVar3 = *(int *)(iVar1 + 0xc);
        }
        piVar3 = (int *)(*(int *)(unaff_gp + -0x7f98) /* -> small */ + 0x18c);
        if (*piVar3 < *(int *)(param_1 + 0x1c)) {
          *piVar3 = *(int *)(param_1 + 0x1c);
        }
        (**(code **)(unaff_gp + -0x7a74) /* -> FUN_00412400 */)(iVar1);
