...

{
  ...
  *param_8 = 0;
  *param_7 = 0;
  (**(code **)(unaff_gp + -0x7924) /* -> FUN_0042631c */)(&local_4,&local_c,&local_8);
  if (local_c == 0) {
    if (local_4 == 0) {
      if (local_8 == 0) {
        ...
        local_4 = local_8;
        if ((local_8 == *(int *)(**(int **)(unaff_gp + -0x7684) /* -> curcontext */ + 0x44)) &&
           (*(int *)(local_8 + 0x28) != 0)) {
          local_4 = *(int *)(local_8 + 0x28);
        }
        (**(code **)(unaff_gp + -0x79c4) /* -> FUN_0041d69c */)(local_4);
    ...
    (**(code **)(unaff_gp + -0x79c4) /* -> FUN_0041d69c */)(local_4);
    (**(code **)(unaff_gp + -0x79bc) /* -> FUN_0041da44 */)(local_c);
    piVar2 = *(int **)(unaff_gp + -0x7684) /* -> curcontext */;
    iVar1 = *(int *)(unaff_gp + -0x75dc) /* -> fsn_resources */;
