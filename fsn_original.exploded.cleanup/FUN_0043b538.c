...

{
  ...
  if (piVar4 == (int *)0x0) {
    **(undefined4 **)(unaff_gp + -0x7f70) /* -> EXTERNAL_0x0fb52720 */ = 2;
  }
  else {
    if (piVar4[3] == 0) {
      (**(code **)(unaff_gp + -0x76fc) /* -> FUN_0043b3b8 */)(param_1,piVar4);
    }
    if ((uint)(piVar4[6] - piVar4[5]) < 4) {
      ...
      (**(code **)(unaff_gp + -0x76f4) /* -> getword__FPcPl */)(piVar4[5],&local_14);
      iVar2 = piVar4[5];
    }
    if ((uint)(piVar4[6] - iVar2) < local_14 + 4U) {
      **(undefined4 **)(unaff_gp + -0x7f70) /* -> EXTERNAL_0x0fb52720 */ = 0x43;
    }
    else {
      iVar1 = 0;
      if (local_14 < param_4) {
      ...
      if ((uint)(piVar4[6] - iVar2) < 4) {
        ...
        (**(code **)(unaff_gp + -0x76f4) /* -> getword__FPcPl */)(iVar2,local_10);
