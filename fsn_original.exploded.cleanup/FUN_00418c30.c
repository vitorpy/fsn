...

{
  ...
  if ((int)(param_1[0x1d] << 3) < 0) {
    ...
    (**(code **)(unaff_gp + -0x7b9c) /* -> EXTERNAL_0x0f124424 */)(*(undefined4 *)(*(int *)(unaff_gp + -0x75dc) /* -> fsn_resources */ + 0x170));
    dVar4 = (double)-*(float *)(*(int *)(unaff_gp + -0x75dc) /* -> fsn_resources */ + 0xe4);
    fVar5 = (float)(dVar4 / (double)((ulonglong)unaff_000010a0 << 0x20));
    (**(code **)(unaff_gp + -0x7e20) /* -> EXTERNAL_0x0f1273b8 */)(fVar5,fVar5);
    ...
    uVar3 = (uint)((ulonglong)dVar4 >> 0x20);
    uVar6 = *(undefined4 *)(*(int *)(unaff_gp + -0x7fa4) /* -> DAT_10010000 */ + -0x5120);
    (**(code **)(unaff_gp + -0x7b6c) /* -> EXTERNAL_0x0f1268e4 */)(uVar6,uVar6);
    (**(code **)(unaff_gp + -0x7a08) /* -> FUN_004189b0 */)(*param_1);
    (**(code **)(unaff_gp + -0x7b28) /* -> EXTERNAL_0x0f1261ac */)();
    (**(code **)(unaff_gp + -0x7b48) /* -> EXTERNAL_0x0f127d3c */)();
    iVar1 = (**(code **)(unaff_gp + -0x7c20) /* -> EXTERNAL_0x0fabeea8 */)(param_2);
    dVar4 = (double)iVar1;
    if (iVar1 < 0) {
    ...
    uVar7 = *(undefined4 *)(*(int *)(unaff_gp + -0x7fa4) /* -> DAT_10010000 */ + -0x5108);
