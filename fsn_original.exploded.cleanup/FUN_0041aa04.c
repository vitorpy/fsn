...

{
  ...
  if (param_3 != *(int *)(**(int **)(unaff_gp + -0x7684) /* -> curcontext */ + 0x3c)) {
    (**(code **)(unaff_gp + -0x7b48) /* -> EXTERNAL_0x0f127d3c */)();
    iVar4 = *(int *)(**(int **)(unaff_gp + -0x7684) /* -> curcontext */ + 0x3c);
    if (param_3 == *(int *)(iVar4 + 0x28)) {
      (**(code **)(unaff_gp + -0x79f0) /* -> FUN_0041a908 */)
                ((ulonglong)uVar6 << 0x20,
                 (double)*(float *)(iVar4 + 0x3c) +
                 (double)*(float *)(*(int *)(unaff_gp + -0x75dc) /* -> fsn_resources */ + 0xdc));
    }
      ...
      if (0 < iVar3) {
        ...
        do {
          if (param_3 == *piVar2) {
            fVar5 = *(float *)(*(int *)(unaff_gp + -0x75dc) /* -> fsn_resources */ + 0xd0);
            ...
            (**(code **)(unaff_gp + -0x7b60) /* -> EXTERNAL_0x0f1264f4 */)(uVar8,iVar3,iVar4,0);
            ...
            uVar9 = *(undefined4 *)(*(int *)(unaff_gp + -0x7fa4) /* -> DAT_10010000 */ + -0x509c);
            (**(code **)(unaff_gp + -0x7df0) /* -> EXTERNAL_0x0f1253e4 */)(uVar9,uVar9);
            break;
          }
          iVar1 = iVar1 + 1;
          piVar2 = piVar2 + 1;
