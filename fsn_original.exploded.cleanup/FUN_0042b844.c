...

{
  ...
  (**(code **)(unaff_gp + -0x7e5c) /* -> EXTERNAL_0x0f698dc4 */)
  ...
  (**(code **)(unaff_gp + -0x7e54) /* -> EXTERNAL_0x0f68759c */)
            (param_1,*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6e20,*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + -0x76e8,1,
             0,0);
  iVar3 = *(int *)(*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6e20);
  if (iVar3 == 0) {
    iVar3 = (**(code **)(unaff_gp + -0x7cbc) /* -> EXTERNAL_0x0f1207cc */)(9);
    piVar2 = (int *)(*(int *)(unaff_gp + -0x7f94) /* -> DAT_10010000 */ + 0x6e20);
    if (iVar3 < 4) {
      iVar3 = *(int *)(unaff_gp + -0x7fa4) /* -> DAT_10010000 */ + 0x2c34;
      *piVar2 = iVar3;
    }
    else {
      iVar3 = *(int *)(unaff_gp + -0x7fa4) /* -> DAT_10010000 */ + 0x2c3c;
      *piVar2 = iVar3;
    }
  }
  if (iVar3 == 0) {
    ...
    uVar1 = (**(code **)(unaff_gp + -0x7c64) /* -> EXTERNAL_0x0f67f938 */)
    ...
    (**(code **)(unaff_gp + -0x7e54) /* -> EXTERNAL_0x0f68759c */)
              (uVar1,*(undefined4 *)(unaff_gp + -0x75dc) /* -> fsn_resources */,*(int *)(unaff_gp + -0x7f98) /* -> small */ + 0x7c30,0x76,
               0,0);
    (**(code **)(unaff_gp + -0x7ec8) /* -> EXTERNAL_0x0f68e850 */)(uVar1);
  }
  (**(code **)(unaff_gp + -0x77f0) /* -> FUN_00433904 */)
            (param_1,*(int *)(unaff_gp + -0x7fa4) /* -> DAT_10010000 */ + 0x2c44,*(int *)(unaff_gp + -0x7fa4) /* -> DAT_10010000 */ + 0x2c4c);
