...

{
  ...
  uVar3 = (uint)*param_1;
  if (uVar3 != 0) {
    iVar5 = *(int *)(unaff_gp + -0x76cc) /* -> chrtbl */;
    do {
      ...
      if ((iVar1 != 0) && (iVar1 != 0)) {
        ...
        do {
          if (iVar1 == 1) {
            ...
            (**(code **)(unaff_gp + -0x7b60) /* -> EXTERNAL_0x0f1264f4 */)((float)*(int *)(iVar1 + 4),(float)*(int *)(iVar1 + 8))
            ;
            uVar3 = (uint)*param_1;
            iVar1 = iVar5 + uVar3 * 0xd8 + iVar4;
LAB_00418bcc:
            ...
            if (iVar1 == 2) {
              ...
              (**(code **)(unaff_gp + -0x7c68) /* -> EXTERNAL_0x0f123fe0 */)(iVar5 + (uint)*param_1 * 0xd8 + iVar4 + 4);
              uVar3 = (uint)*param_1;
              iVar1 = iVar5 + uVar3 * 0xd8 + iVar4;
              goto LAB_00418bcc;
            }
            ...
            if (iVar1 == 3) {
              (**(code **)(unaff_gp + -0x7c68) /* -> EXTERNAL_0x0f123fe0 */)(iVar2 + 4);
              uVar3 = (uint)*param_1;
              iVar1 = iVar5 + uVar3 * 0xd8 + iVar4;
              goto LAB_00418bcc;
            }
