...

{
  ...
  puVar1 = (undefined4 *)/* TODO: GP:-0x7b40 */ (**(code **)(unaff_gp + -0x7b40) /* -> EXTERNAL_0x0f66b118 */)(0xc);
  uVar2 = /* TODO: GP:-0x7e90 */ (**(code **)(unaff_gp + -0x7e90) /* -> EXTERNAL_0x0e35c908 */)(param_1);
  *puVar1 = uVar2;
  local_54 = /* TODO: GP:-0x7f60 */ *(int *)(unaff_gp + -0x7f60) /* -> EXTERNAL_0x0e3f2368 */;
  piVar3 = (int *)(small /* was: *(int *)(unaff_gp + -0x7f98) */ /* -> small */ + 0x20);
  iVar4 = *piVar3;
